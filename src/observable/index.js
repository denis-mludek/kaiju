...
/* Exports every capabilities of Observables in a single module */
...
import create, { proto } from './create'


export const Observable = create
...
proto.sliding2 = function() { return _sliding(this) }
